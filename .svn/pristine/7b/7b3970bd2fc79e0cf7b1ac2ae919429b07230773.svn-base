...
//    //cout << endl;
//    complete_best_path = generate_best_path_greedy(depots, pickup_dropoff_ids, new_nodes_to_look_at, new_nodes_to_look_at.size(), turn_penalty);
////    for (unsigned int itt = 0; itt < complete_best_path.size(); itt++) {
////                    
////        cout << complete_best_path[itt] << ": " << itt;
////        if (dependency.find(complete_best_path[itt]) != dependency.end())
////            cout << " LAST OCCUR: " << last_occurence_of_dropoff[complete_best_path[itt]];
////
////        cout << endl;
////    }
...
//                //cout << pickup_dropoff_ids[sub_vector[x]][i] << " | " << last_occurence_of_dropoff[pickup_dropoff_ids[sub_vector[x]][i]] << endl;
...
//vector<unsigned> generate_2_opt(vector<unsigned> best, unordered_map < unsigned, vector<unsigned> > pickup_dropoff_ids) {
//    auto startTime = chrono::high_resolution_clock::now();
//    //unsigned startD = best[0];
//    //unsigned endD = best.back();
...
//                best = current_best;
//
////                cout << "Accept 2-opt: x = " << x << ", y = " << y << " new cost: " << new_permutation_cost << "original cost: " << original_permutation_cost << endl;
////                for (unsigned int itt = 0; itt < best.size(); itt++) {
////                    
////                    cout << best[itt] << ": " << itt;
////                    if (dependency.find(best[itt]) != dependency.end())
////                        cout << " LAST OCCUR: " << last_occurence_of_dropoff[best[itt]];
////                   
////                    cout << endl;
////                }
////
...
//        }
//    }
//    //best.insert(best.begin(), startD);
//    //best.insert(best.end(), endD);
//    
//    auto currentTime4 = chrono::high_resolution_clock::now();
//    auto wallClock4 = chrono::duration_cast <chrono::duration<double>> (currentTime4 - startTime);
//
//    
//    return best;
//}
