...
void set_visible_world(float xl, float yb, float xr, float yt, bool save = true);
void set_visible_world(const t_bound_box& bounds, bool save = true);
...
void drawtext(float xc, float yc, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX, bool center = true);
