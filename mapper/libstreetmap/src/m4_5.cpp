...
//
//
//                    original_permutation_cost += find_distance_between_two_points(getIntersectionPosition(best_path_intersections[x - 1]), getIntersectionPosition(best_path_intersections [x]));
//                    new_permutation_cost += find_distance_between_two_points(getIntersectionPosition(new_path_intersections[x - 1]), getIntersectionPosition(new_path_intersections[x]));
//
//
//                }
//
//                if (y != best_path_intersections.size() - 1) {
//                    original_permutation_cost += find_distance_between_two_points(getIntersectionPosition(best_path_intersections[y]), getIntersectionPosition(best_path_intersections[y + 1]));
//                    new_permutation_cost += find_distance_between_two_points(getIntersectionPosition(new_path_intersections[y]), getIntersectionPosition(new_path_intersections[y + 1]));
//
//
//                }
//
