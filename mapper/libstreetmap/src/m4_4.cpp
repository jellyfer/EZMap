...
//            for (unsigned int x = 0; x < pickup_dropoff_ids[intersection_next].size(); x++)
//                nodes_to_look_at.insert(pickup_dropoff_ids[intersection_next][x]);
//            pickup_has_been_visited[intersection_next] = true;
...
//                if (path_cost.find(best_path_intersections[x - 1]) != path_cost.end()
//                        && path_cost[best_path_intersections[x - 1]].find(best_path_intersections [x]) != path_cost[best_path_intersections[x - 1]].end()) {
//                    original_permutation_cost += path_cost[best_path_intersections[x - 1]][best_path_intersections [x]].cost;
//                } else {
//                    if (best_path_intersections[x - 1] != best_path_intersections [x]) {
//                        unordered_set <unsigned> next_intersection;
//                        next_intersection.insert(best_path_intersections [x]);
//                        vector_and_intersection v = modified_Dijkstra(best_path_intersections[x - 1], next_intersection, turn_penalty);
//                        double travel_time = compute_path_travel_time(v.path, turn_penalty);
//                        path_and_cost pc;
//                        pc.cost = travel_time;
//                        pc.path = v.path;
//                        path_cost[best_path_intersections[x - 1]][best_path_intersections [x]] = pc;
//                        original_permutation_cost += travel_time;
//                    }
//                }
//
//
...
//                } else {
//                    if (new_path_intersections[x - 1] != new_path_intersections[x]) {
//                        unordered_set <unsigned> next_intersection;
...
//                if (path_cost.find(best_path_intersections[y]) != path_cost.end()
//                        && path_cost[best_path_intersections[y]].find(best_path_intersections[y + 1]) != path_cost[best_path_intersections[y]].end()) {
//                    original_permutation_cost += path_cost[best_path_intersections[y]][best_path_intersections[y + 1]].cost;
//                } else {
//                    if (best_path_intersections[y] != best_path_intersections[y + 1]) {
//                        unordered_set <unsigned> next_intersection;
//                        next_intersection.insert(best_path_intersections[y + 1]);
//                        vector_and_intersection v = modified_Dijkstra(best_path_intersections[y], next_intersection, turn_penalty);
//                        double travel_time = compute_path_travel_time(v.path, turn_penalty);
//                        path_and_cost pc;
//                        pc.cost = travel_time;
//                        pc.path = v.path;
//                        path_cost[best_path_intersections[y]][best_path_intersections[y + 1]] = pc;
//                        original_permutation_cost += travel_time;
//                    }
//
//                }
...
//                } else {
//                    if (new_path_intersections[y + 1] != new_path_intersections[y]) {
//                        unordered_set <unsigned> next_intersection;
...
//
//        if (best_path_intersections[i] == best_path_intersections[i + 1]) {
//            continue;
//        }
//
